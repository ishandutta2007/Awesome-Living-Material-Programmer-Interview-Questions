...
|---|----------|-----------------|
| 1 | [Engineered Living Materials Fundamentals](questions/01-engineered-living-materials-fundamentals.md) | What ELMs are, why incorporate living cells into a material, the living-to-inert spectrum |
| 2 | [Genetic Programming for Material-Relevant Behaviors](questions/02-genetic-programming-for-material-behaviors.md) | Circuit design for growth, secretion, mineralization, and sensing within a material context |
| 3 | [Material-Cell Interface & Scaffold Design](questions/03-material-cell-interface-and-scaffold-design.md) | Encapsulation, hydrogels, bioprinting, and how cells physically integrate with a matrix |
| 4 | [Self-Healing, Growth & Responsive Behaviors](questions/04-self-healing-growth-and-responsive-behaviors.md) | Programmed self-repair, growth-based fabrication, stimuli-responsive materials |
| 5 | [Viability, Stability & Long-Term Function](questions/05-viability-stability-and-long-term-function.md) | Keeping cells alive and functional in a material without conventional lab infrastructure |
| 6 | [Characterization & Testing of Living Materials](questions/06-characterization-and-testing.md) | The unique challenge of jointly testing mechanical and biological properties |
| 7 | [Biosafety, Containment & Regulatory Considerations](questions/07-biosafety-containment-and-regulatory.md) | Kept at the conceptual/policy level — genetic containment, kill switches, environmental release |
...
```
living-material-programmer-interview-questions/
├── README.md                                          ← you are here
├── CONTRIBUTING.md
├── LICENSE
├── resources.md
└── questions/
    ├── 01-engineered-living-materials-fundamentals.md
    ├── 02-genetic-programming-for-material-behaviors.md
    ├── 03-material-cell-interface-and-scaffold-design.md
    ├── 04-self-healing-growth-and-responsive-behaviors.md
    ├── 05-viability-stability-and-long-term-function.md
    ├── 06-characterization-and-testing.md
    ├── 07-biosafety-containment-and-regulatory.md
    └── 08-behavioral-and-case-studies.md
```

## 🤝 Contributing

PRs are the whole point of this repo. If you were asked a question in a real interview that isn't here, add it! See [CONTRIBUTING.md](CONTRIBUTING.md) for format guidelines — note in particular the biosafety/containment content guidelines, which keep this repo at the conceptual/policy level only.
